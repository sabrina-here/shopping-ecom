...
export default function NewArrival() {
  ...
  return (
    ...
    >
      ...
      <button
        data-aos="zoom-in"
        className="text-black text-md font-semibold px-8 py-4 rounded-md transform hover:scale-105 transition-transform duration-300 mt-10 bg-transparent border-2 border-black dark:border-white dark:text-white"
      >
        View More
      </button>
    </section>
